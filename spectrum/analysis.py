...
def PlotSpectrum(object, satelite):
    ...
    if satelite=="Chandra" or satelite=="Swift":
        ...
        if satelite=="Chandra":
            ...
            matplotlib.pyplot.text      (numpy.logspace(0.00, 2.00, 11)[1], numpy.logspace(-6.00, +2.00, 9)[7], object.replace("--","-"))
...
if __name__=="__main__":
    ...
    satelites       = [ "Swift", "Chandra",  "Suzaku",   "Swift", "Chandra", "Chandra", "Chandra", "Suzaku", "Chandra",  "Suzaku",  "Suzaku",  "Swift", "Chandra",  "Newton",  "Swift",  "Suzaku",  "Suzaku",  "Swift", "Suzaku", "Chandra",   "Swift",  "Swift",  "Swift",  "Swift",  "Swift",  "Swift",  "Newton",   "Swift", "Newton", "Newton",
                       "Newton",  "Newton", "Chandra",  "Suzaku", "Chandra", "Chandra",  "Newton",  "Swift",  "Newton", "Chandra",   "Swift", "Suzaku",  "Suzaku",   "Swift", "Suzaku",   "Swift",  "Suzaku", "Newton", "Newton",  "Suzaku",   "Swift",  "Swift", "Suzaku",  "Swift", "Suzaku", "Newton", "Chandra", "Chandra",  "Swift", "Newton",
