...
def SpectralAnalysis(column, redshift, satelite, simultaneous, gaussian, length):
    ...
    xspec.Model("constant*phabs*(constant*cabs*zphabs*zcutoffpl+constant*zcutoffpl+atable{/Users/tanimoto/analysis/model/xclumpy/xclumpy_v01_RC.fits}+atable{/Users/tanimoto/analysis/model/xclumpy/xclumpy_v01_RL.fits}+zgauss)")
...
def WriteTable(object, simultaneous, gaussian):
    ...
    with open("parameter.txt", mode="w") as fout:
        ...
        if simultaneous==True:
            fout.write("{0:<78}".format("${0:0<4}$ (fixed)".format(round(1e+00*xspec.AllModels(1)(3) .values[0],2)))                                                                                                                                                                                                              +"&\n")
        else:
            fout.write("{0:<78}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+00*xspec.AllModels(1)(3) .values[0], 2), round(1e+00*(xspec.AllModels(1)(3) .values[0]-xspec.AllModels(1)(3) .error[0]), 2), round(1e+00*(xspec.AllModels(1)(3) .error[1]-xspec.AllModels(1)(3) .values[0]),2)))+"&\n")
               
        fout.write("{0:<80}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+00*xspec.AllModels(1)(7) .values[0], 2), round(1e+00*(xspec.AllModels(1)(7) .values[0]-xspec.AllModels(1)(7) .error[0]), 2), round(1e+00*(xspec.AllModels(1)(7) .error[1]-xspec.AllModels(1)(7) .values[0]), 2)))+"& "    )
        fout.write("{0:<78}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+02*xspec.AllModels(1)(10).values[0], 2), round(1e+02*(xspec.AllModels(1)(10).values[0]-xspec.AllModels(1)(10).error[0]), 2), round(1e+02*(xspec.AllModels(1)(10).error[1]-xspec.AllModels(1)(10).values[0]), 2)))+"&\n"   )
        fout.write("{0:<80}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+02*xspec.AllModels(1)(11).values[0], 2), round(1e+02*(xspec.AllModels(1)(11).values[0]-xspec.AllModels(1)(11).error[0]), 2), round(1e+02*(xspec.AllModels(1)(11).error[1]-xspec.AllModels(1)(11).values[0]), 2)))+"& "    )
        fout.write("{0:<78}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e-02*xspec.AllModels(1)(4) .values[0], 2), round(1e-02*(1.645*statistics.stdev(hydrogen))                                , 2), round(1e-02*(1.645*statistics.stdev(hydrogen))                                , 2)))+"&\n"   )
        fout.write("{0:<80}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+00*xspec.AllModels(1)(16).values[0], 2), round(1e+00*(xspec.AllModels(1)(16).values[0]-xspec.AllModels(1)(16).error[0]), 2), round(1e+00*(xspec.AllModels(1)(16).error[1]-xspec.AllModels(1)(16).values[0]), 2)))+"& "    )
        fout.write("{0:<78}".format("")                                                                                                                                                                                                                                                                    +"\\\\\n")
        fout.write("{0:<80}".format("")                                                                                                                                                                                                                                                                    +"& "    )
        fout.write("{0:<78}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+00*xspec.AllModels(1)(17).values[0], 1), round(1e+00*(xspec.AllModels(1)(17).values[0]-xspec.AllModels(1)(17).error[0]), 2), round(1e+00*(xspec.AllModels(1)(17).error[1]-xspec.AllModels(1)(17).values[0]), 2)))+"&\n"   )
        fout.write("{0:<80}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+00*xspec.AllModels(1)(18).values[0], 1), round(1e+00*(xspec.AllModels(1)(18).values[0]-xspec.AllModels(1)(18).error[0]), 2), round(1e+00*(xspec.AllModels(1)(18).error[1]-xspec.AllModels(1)(18).values[0]), 2)))+"& "    )
        
        if gaussian==True:
            fout.write("{0:<78}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+00*xspec.AllModels(1)(30).values[0], 1), round(1e+00*(xspec.AllModels(1)(30).values[0]-xspec.AllModels(1)(30).error[0]), 2), round(1e+00*(xspec.AllModels(1)(30).error[1]-xspec.AllModels(1)(30).values[0]), 2)))+"&\n")
            fout.write("{0:<80}".format("${0:0<4}_{{-{1:0<4}}}^{{+{2:0<4}}}$".format(round(1e+04*xspec.AllModels(1)(33).values[0], 1), round(1e+04*(xspec.AllModels(1)(33).values[0]-xspec.AllModels(1)(33).error[0]), 2), round(1e+04*(xspec.AllModels(1)(33).error[1]-xspec.AllModels(1)(33).values[0]), 2)))+"& " )
        else:
            fout.write("{0:<78}".format("\\nodata")                                                                                                                                                                                                                                                            +"&\n")
            fout.write("{0:<80}".format("\\nodata")                                                                                                                                                                                                                                                            +"& " )
...
if __name__=="__main__":
    columns         = [0.03310, 0.46400, 0.05720, 0.02470, 0.03200, 0.02000, 0.02110, 0.01720, 0.06140, 0.02850, 0.02160, 0.02240, 0.05230, 0.09670, 0.05540, 0.00831, 0.00859, 0.10300, 0.12600, 0.01170, 0.17100, 0.00979, 0.03370, 0.08470, 0.23100, 0.03340, 0.03820, 0.06930,
                       0.15800, 0.28200, 0.40700, 0.03520, 0.03860, 0.02170, 0.03760, 0.04520, 0.04560, 0.02980, 0.05190, 0.02340, 0.04650, 0.08160, 0.01320, 0.03030, 0.02080, 0.03940, 0.01620, 0.10800, 0.08710, 0.05400, 0.06590, 0.02840, 0.01910, 0.01790, 0.00674, 0.01420,
                       0.01220, 0.01140, 0.01840, 0.06590, 0.02570, 0.00850, 0.06800, 0.05340, 0.02250, 0.03090, 0.01940, 0.01710, 0.05090, 0.02040, 0.03820, 0.01200, 0.01360, 0.01900, 0.00955, 0.06320, 0.09180, 0.01880, 0.02760, 0.07610, 0.03900, 0.01890, 0.00772, 0.04150,
                       0.08010, 0.03200, 0.03290, 0.06340, 0.05180, 0.17300, 0.05820, 0.05500, 0.15900, 0.13200, 0.19100, 0.04770, 0.82000, 0.05830, 0.06270, 0.02520, 0.02380, 0.05770, 0.94300, 0.05730, 0.04780, 0.01290, 0.06430, 0.08710, 0.09940, 0.06280, 0.01410, 0.01390]
    ...
    redshifts       = [0.07333, 0.01165, 0.01503, 0.04746, 0.04963, 0.01213, 0.01195, 0.02977, 0.00946, 0.01669, 0.01360, 0.01695, 0.06120, 0.05185, 0.02885, 0.10877, 0.09727, 0.10308, 0.04610, 0.10230, 0.01541, 0.03306, 0.02776, 0.02897, 0.11470, 0.02243, 0.04052, 0.04133,
                       0.08245, 0.02940, 0.02569, 0.01580, 0.01350, 0.03443, 0.03305, 0.02182, 0.06484, 0.05397, 0.03621, 0.00467, 0.01113, 0.09102, 0.02683, 0.02563, 0.05810, 0.00798, 0.18490, 0.03354, 0.02845, 0.01515, 0.01067, 0.03358, 0.03276, 0.08787, 0.04756, 0.02685,
                       0.03150, 0.02488, 0.06353, 0.03971, 0.00842, 0.01038, 0.01180, 0.02502, 0.00372, 0.01038, 0.02515, 0.03194, 0.01654, 2.15000, 0.01241, 0.04035, 0.01014, 0.06332, 0.03689, 0.12300, 0.01626, 0.00864, 0.04400, 0.05151, 0.02392, 0.05470, 0.03046, 0.10344,
                       0.00370, 0.04202, 0.09769, 0.01690, 0.00200, 0.01947, 0.01329, 0.06254, 0.06290, 0.05900, 0.06495, 0.06063, 0.01700, 0.02914, 0.11430, 0.00877, 0.05375, 0.01135, 0.02000, 0.07874, 0.05588, 0.02644, 0.02251, 0.08100, 0.01699, 0.01743, 0.59732, 0.09631]
    satelites       = [  "Swift", "Chandra",  "Suzaku",   "Swift", "Chandra", "Chandra", "Chandra",  "Suzaku", "Chandra",  "Suzaku",  "Suzaku", "Chandra",  "Newton",   "Swift",  "Suzaku",  "Suzaku",   "Swift",  "Suzaku", "Chandra",   "Swift",   "Swift",   "Swift",   "Swift",   "Swift",   "Swift",  "Newton",   "Swift",  "Newton",
                       "Chandra",  "Newton",  "Newton", "Chandra",  "Suzaku", "Chandra", "Chandra",  "Newton",  "Newton", "Chandra",   "Swift",  "Suzaku",  "Suzaku",   "Swift",  "Suzaku",   "Swift",  "Suzaku",  "Newton",  "Newton",  "Suzaku",   "Swift",   "Swift",  "Suzaku",   "Swift",  "Suzaku",  "Newton", "Chandra", "Chandra",
                        "Newton",   "Swift", "Chandra",   "Swift",  "Newton", "Chandra",  "Suzaku",  "Suzaku",  "Suzaku",  "Newton",  "Suzaku",   "Swift",  "Newton",   "Swift",  "Newton",  "Newton", "Chandra", "Chandra",  "Newton",  "Newton",  "Suzaku", "Chandra",   "Swift",   "Swift",   "Swift",  "Suzaku",  "Suzaku",  "Newton", 
