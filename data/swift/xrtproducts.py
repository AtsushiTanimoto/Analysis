...
if __name__=="__main__":
    ...
    subprocess.run("xrtproducts infile={0:s} regionfile=sour.reg bkgextract=yes bkgregionfile=back.reg outdir=. expofile={1:s} correctlc=no clobber=yes".format(infile, exfile), shell=True)
