...
if __name__=="__main__":
    ...
    subprocess.run("nuproducts indir=. instrument=FPMA steminputs={0:s} outdir=. srcregionfile=src.reg bkgextract=yes bkgregionfile=bkg.reg".format(steminputs), shell=True)
    subprocess.run("nuproducts indir=. instrument=FPMB steminputs={0:s} outdir=. srcregionfile=src.reg bkgextract=yes bkgregionfile=bkg.reg".format(steminputs), shell=True)    
